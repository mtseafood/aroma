  ...
  <router-link :to="`/oils/${oil.id}`"
    ...
    <div class="flex items-stretch">
      ...
      <div class="flex items-center gap-3 p-4 flex-1 min-w-0">
        <div :class="[meta.bg, 'w-11 h-11 rounded-lg flex items-center justify-center flex-shrink-0']">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="text-xs text-stone-300 mt-1.5 tracking-wide">{{ oil.category }} · {{ oil.origin }}</div>
        </div>
